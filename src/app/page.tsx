          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 rounded-2xl bg-surface border border-border overflow-hidden glow-warm">
              <div className="p-4 border-b border-border flex items-center gap-2">
                ...
                <span className="ml-2 text-xs text-neutral-500 font-mono">zhenai — patient view</span>
              </div>
        ...
        <div className="relative p-8 md:p-12 rounded-2xl bg-surface border border-border overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-neutral-400 leading-relaxed mb-4">
              ZhenAI isn&apos;t a generic EHR with a TCM skin. Every feature — from tongue diagnosis to pattern synthesis to herbal prescribing — was designed by someone who&apos;s actually palpated a wiry pulse and debated whether it&apos;s Liver Qi Stagnation or Liver Fire Rising.
            </p>
    ...
    <footer className="border-t border-border py-12">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-neutral-600">
          <p>&copy; {new Date().getFullYear()} ZhenAI. All rights reserved.</p>
